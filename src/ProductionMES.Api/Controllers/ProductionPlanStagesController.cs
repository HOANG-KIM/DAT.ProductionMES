...
/// <summary>
/// Cấu hình công đoạn áp dụng cho từng kế hoạch sản xuất, kèm trình tự (US-03/FR-03). Cùng phân quyền với
/// kế hoạch sản xuất: Tổ trưởng/Quản lý chuyền hoặc Admin (SRS mục 2.2).
/// </summary>
[ApiController]
